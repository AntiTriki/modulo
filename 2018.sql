...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-01-2018 a las 18:21:01
...
(4, 1, 'fdgfdgfdg', 6, '1969-12-31', 1, 1, 3, 5),
(5, 2, 'fdgfdgfdg', 6, '2017-11-14', 1, 1, 3, 5);
...
INSERT INTO `detalle_comprobante` (`id`, `numero`, `glosa`, `debe`, `haber`, `debe_dol`, `haber_dol`, `id_cuenta`, `id_comprobante`, `monto_bol`, `monto_dol`) VALUES
(1, '123', 'POR DETERMINAR', '0.00', '0.00', '0.00', '0.00', 22, 1, NULL, NULL),
(2, NULL, 'fedgfdg', '123.00', '0.00', '0.00', '0.00', 5, 4, NULL, NULL),
(3, NULL, 'dsfdsf', '45.00', '0.00', '0.00', '0.00', 20, 5, NULL, NULL),
(4, NULL, 'dsf', '456.00', '0.00', '0.00', '0.00', 35, 5, NULL, NULL);
...
(11, 1, 'CB', '2017-12-27', '2017-12-28', 0),
...
(1, 'no@no.com', '123', 'Pepe', 'Botellas', 'images/user.jpg', '4566321lp', '2018-01-04 16:31:04'),
