...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-12-2017 a las 12:08:03
...
(1, 1, 'asa', 'asa', 12, '123.00', 4, NULL, NULL, NULL, NULL),
(2, 5, 'queso', 'lacteo', 10, '25.00', 5, NULL, NULL, NULL, NULL);
...
(1, '#', 'Categorias', NULL, 0),
(2, '1', 'Ventas', NULL, 1),
(3, '1', 'Compras', 'asddasd', 1),
(4, '1', 'Accesos', '', 1),
(5, '1', 'Insumos', 'dasfdsf', 5);
...
(4, 4, 'asdasd', 6, '2017-11-14', 1, 1, 3, 1),
(8, 5, 'ASDASd', 6, '2017-11-15', 1, 1, 3, 1),
(9, 6, 'otra vez', 8, '2017-11-28', 1, 1, 4, 1),
(10, 7, 'ASDASd', 6, '2017-11-08', 1, 1, 3, 1),
(11, 8, 'asdasd', 6, '1970-01-01', 1, 1, 3, 1);
...
(12, NULL, 'ertert', NULL, '435.00', '345.00', '0.00', '0.00', 6, 8, NULL, NULL),
(13, NULL, 'ewr', NULL, '34.00', '344.00', '0.00', '0.00', 31, 9, NULL, NULL),
(14, NULL, 'dfg', NULL, '45.00', '45.00', '0.00', '0.00', 35, 11, NULL, NULL);
...
INSERT INTO `lote` (`id`, `id_articulo`, `nro_lote`, `cantidad`, `fecha_ing`, `fecha_ven`, `precio_compra`, `id_nota`) VALUES
(1, 1, 1, 32, '2017-11-08', '2017-11-15', '45.00', NULL);
...
(1, 'no@no.com', '123', 'Pepe', 'Botellas', 'images/user.jpg', '4566321lp', '2017-12-04 04:23:22'),
