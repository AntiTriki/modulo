...
<html>
 ...
 <div class="container-fluid" style="margin-left: 250px">
    ...
    <button type="button" id="nuevo_com" class="btn btn-" ><span class="glyphicon glyphicon-plus" aria-hidden="true" ></span></button>
         ...
         <button type="button" id="crear_com" class="btn btn-success pull-right" style="margin-right: 220px;height: 30px" >Crear</button>
     </div>
     ...
     $('#crear_com').on('click', function(e) {
         ...
         $('.rowCont tr').each(function(row, tr){
                 ...
                 TableData[row] = {
                     ...
                     "cuenta" : $(tr).find('td:eq(0)').text(),
                     "glosa" : $(tr).find('td:eq(1)').text(),
                     "debe" : $(tr).find('td:eq(2)').text(),
                     "haber" : $(tr).find('td:eq(3)').text(),
