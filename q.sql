...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-02-2018 a las 18:25:12
...
(1, 1, 'as', 'asa', 12, '123.00', 6, NULL, NULL, NULL, NULL),
(2, 2, 'Leche', 'sadsad', 56, '32.00', NULL, NULL, NULL, NULL, NULL),
(4, 1, '234234', '12332243', 0, NULL, 2, NULL, NULL, NULL, NULL);
...
INSERT INTO `detalle_nota` (`id`, `cantidad`, `id_notav`, `id_notac`, `id_articulo`, `estado`) VALUES
(1, 13, 1, 0, 4, 1),
(2, 2, 1, 0, 1, 1),
(3, 12, 2, NULL, 4, 1),
(4, 12, 2, NULL, 1, 1),
...
INSERT INTO `lote` (`id`, `id_articulo`, `nro_lote`, `cantidad`, `fecha_ing`, `fecha_ven`, `precio_compra`, `id_notadc`, `estado`) VALUES
...
(1, 'no@no.com', '123', 'Pepe', 'Botellas', 'images/user.jpg', '4566321lp', '2018-02-08 15:54:37'),
